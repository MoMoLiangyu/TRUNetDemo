...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mashiquan/TRUNetworking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mashiquan' => 'mashiquan@86yingji.com' }
  s.source           = { :git => 'https://github.com/mashiquan/TRUNetworking.git', :tag => s.version.to_s }
